...
const Connections = () => {
  ...
  const connState = useSelector((state)=>state.connections) || {}
  const connections = connState.connections || []
  const pendingConnections = connState.pendingConnections || []
  const followers = connState.followers || []
  const following = connState.following || []
