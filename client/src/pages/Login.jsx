    ...
    <div className='min-h-screen flex flex-col md:flex-row'>
      ...
      <div className='flex-1 flex flex-col items-start justify-between p-6 md:p-10 lg:pl-40'>
        ...
        <div>
            ...
            <h1 className='text-3xl md:text-6xl md:pb-2 font-bold bg-gradient-to-r from-indigo-950 to-indigo-800 bg-clip-text text-transparent'>Har connection ki apni kahani</h1>
      ...
      <div className='flex-1 flex items-center justify-center p-6 sm:p-10'>
        <div className='w-full max-w-md'>
          ...
          <div className='mt-4 text-sm text-gray-600'>
            If you don't see the form, open DevTools Console and Network.
          </div>
          <div className='mt-2 text-xs text-gray-400'>Publishable key: {import.meta.env.VITE_CLERK_PUBLISHABLE_KEY ? 'loaded' : 'missing'}</div>
        </div>
      </div>
    </div>
  )
